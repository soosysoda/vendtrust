...
export default function FooterCTA() {
  return (
    <div className="rounded-xl bg-linear-to-r from-indigo-600 to-violet-500 text-white p-8">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
          <a href="/auth/signup" className="px-6 py-3 bg-white text-indigo-600 font-medium rounded">Create account</a>
